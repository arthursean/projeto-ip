...
play_button_sprite = button.Button((c.screen_width//2) -60, (c.screen_height//2) -20, play_button, True)
...
continue_sprite = button.Button(c.screen_width- 215, c.screen_height-128-80, continue_button, True)