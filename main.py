...
times_speed_sprite = button.Button(c.screen_width - 200, c.screen_height-400, times_speed_button, False)
pause_sprite = button.Button(c.screen_width - 70, c.screen_height-400, pause_button, True)
running = True
pygame.font.init()
