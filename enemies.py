...
class rapido(inimigo):
    def __init__(self, path):
        super().__init__(path, velocidade=4, vida=40, img_path="imagens/inimigos.png", dmg = 40)

class tank(inimigo):
    def __init__(self, path):
        super().__init__(path, velocidade=1.5, vida=75, img_path="imagens/inimigos.png", dmg = 25)
